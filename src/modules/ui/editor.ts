...
export const generateEditorColor: GenerateUIWithBaseColor = (base, ui, isDark) => ({
  ...
  editorBracketHighlight: {
    ...
    foreground2: (isDark ? darken : brighten)(base.pink, 10, (c) =>
      isDark ? c.desaturate(30) : c.spin(5).saturate(15),
    ),
    foreground3: (isDark ? darken : brighten)(base.cyan, 10, (c) =>
      isDark ? c.desaturate(20) : c.spin(5).saturate(15),
    ),
    foreground4: (isDark ? darken : brighten)(base.orange, 10, (c) =>
      isDark ? c.desaturate(20) : c.spin(5).saturate(15),
    ),
  },
  editorLink: {
